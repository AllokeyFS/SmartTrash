...
class LevenshteinTest {
    ...
    fun `case sensitive check`() {
        // Алгоритм чувствителен к регистру — проверяем что lowercasing работает
        val lower = "battery".levenshteinSimilarity("battery")
        val mixed = "Battery".levenshteinSimilarity("battery")
        // Mixed будет ниже — напоминание что в Repository мы делаем lowercase
